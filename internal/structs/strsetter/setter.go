...
// Package strsetter provides a field setter compiler for string.
package strsetter
...
type SetterCompiler func(reflect.Type) SetterFunc
...
func unsupportedType(_ reflect.Type, v reflect.Value, _ string) error {
