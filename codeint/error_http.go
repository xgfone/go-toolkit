...
var (
	...
	ErrMissingContentType   = ErrBadRequest.WithMessage("missing the header Content-Type")
	ErrMissingAuthorization = ErrBadRequest.WithMessage("missing the header Authorization")
)
